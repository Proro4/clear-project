...
var paths = {
    src: {
        ...
        vendorJs    : [
            ...
            'bower_components/circle-progress-bar/build/circle-progress-bar.min.js',
            'app/vendor/js/slick.min.js',
            'app/vendor/js/marker_map.js',
            'app/vendor/js/datepicker.js',
...
gulp.task('watch', ['browser-sync', 'vendor-css', 'vendor-js', 'fonts','pug', 'scss', 'html', 'babel', 'static'], function () {
...
gulp.task('build', ['clean', 'img', 'vendor-css', 'vendor-js', 'fonts', 'scss', 'pug', 'babel', 'html', 'static']);
